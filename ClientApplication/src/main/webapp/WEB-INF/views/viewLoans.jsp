 ...
 -->					<th>Save Collateral</th>
			...
			<tbody>
				<c:forEach items="${result}" var="result">
					<tr>
						<td>${result.loanId}</td>
						<td>$${result.loanPricipal}</td>
						<td>${result.tenure}years</td>
						<td>${result.interest}%</td>
<%-- 						<td>${result.collateralId}</td>
 --%>						<td><a href="collateral" type="submit"
							class="btn btn-success">Save Collateral</a></td>
						<td><a href="risk?loanid=${result.loanId}" type="submit"
							class="btn btn-success">View Risk</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
